      ...
      <section className="grid place-items-center gap-2">
        {location > 0 && (
          <div className="bg-[rgba(255,255,255,0.15)] w-full my-2">
            <h2 className="grid place-items-center text-2xl font-semibold">
              Location Cordinates
            </h2>
            <h2 className="grid place-items-center font-medium">
              Latitude:{lat}
            </h2>
            <h2 className="grid place-items-center font-medium">
              Longitude:{long}
            </h2>
            <div className="grid place-items-center font-semibold text-xl">
              Location: {data.name}
            </div>
            {data.sys ? (
        ...
        <button
          onClick={getLocation}
          className="rounded-md ml-2 bg-slate-600 py-2 px-3 hover:font-semibold"
        >
          Find Me <FaSearch />
        </button>
        <button
        ...
        <div>
          <section className="my-2 grid place-items-center max-w-3xl mx-auto">
            <div className="rounded-md py-8 px-8 flex flex-col bg-[rgba(255,255,255,0.15)]">
              ...
              {data.weather ? (
                <p className="grid place-items-center my-3 font-medium text-lg">
                  {data.weather[0].main}
                </p>
              ) : null}
              {data.weather ? (
